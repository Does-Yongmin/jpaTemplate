...
<div id="pageTitle">쇼핑가이드 > 쇼핑 테마 등록</div>
<ul class="pageGuide">
    <li>*는 필수입력항목입니다.</li>
    <li>등록 매장은 <b>최대 4개</b>까지 등록 가능하며 등록된 매장 한해 검색하여 선택가능합니다.</li>
<%--    <li>등록 매장의 노출 순서는 드래그앤 드랍으로 변경 가능하며, 하단의 순서저장을 눌러야 저장됩니다.</li>--%>
...
<script>
    ...
    // const thumbImgInput = document.querySelector('input[name="thumbImg.file"]');
    ...
    // thumbImgInput.addEventListener('input', function () {
    //     const currLang       = document.querySelector('.lang-select a.selected').getAttribute('data-lang');
    //     updateLangBoxColor(currLang, true);
    // });

    function updateLangBoxColor(lang, fileChange) {
        let langBox;
        if (lang === 'KO') {
        ...
        // const fileHref       = document.querySelector('.uploaded a');
