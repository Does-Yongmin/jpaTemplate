...
<div id="pageTitle">쇼핑가이드 관리 <span style="color: #d14a4a;">*현재 미운영되고 있는 메뉴입니다.</span></div>

<ul class="pageGuide">
    <li>쇼핑 가이드 테마를 관리할 수 있습니다.<b>최소 2개 이상의 테마 등록이 필요</b>합니다.</li>
    <li>게시글은 <b>쇼핑가이드 테마 영역</b>에 등록 이미지와 함께 노출됩니다.</li>
    <li>순서는 드래그하여 변경할 수 있으며, <b>변경 후 반드시 하단의 '순서저장' 버튼을 눌러야 합니다.</b></li>
</ul>
