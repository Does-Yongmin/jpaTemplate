...
<div class="listBox-grid">
    <table>
        ...
        <tr>
            ...
            <th style="width: 150px;">수정 전 권한</th>
            <th style="width: 150px;">수정 후 권한</th>
            <th style="width:100px;">권한 부여자</th>
        ...
        <c:forEach items="${list}" var="vo" varStatus="status">
            <tr>
                ...
                <td><c:out value="${vo.permBeforeRemoveDivTags}"/></td>
                <td><c:out value="${vo.permAfterRemoveDivTags}"/></td>
                <td><c:out value="${vo.authorizerEmail}(${vo.authorizerNm})"/></td>
