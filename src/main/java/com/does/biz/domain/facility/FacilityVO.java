...
//	private FacilityLangInfo facilityLangInfoKo = FacilityLangInfo.builder().lang("KO").build();
//	private FacilityLangInfo facilityLangInfoEn = FacilityLangInfo.builder().lang("EN").build();
//	private FacilityLangInfo facilityLangInfoJp = FacilityLangInfo.builder().lang("JP").build();
//	private FacilityLangInfo facilityLangInfoCn = FacilityLangInfo.builder().lang("CN").build();
